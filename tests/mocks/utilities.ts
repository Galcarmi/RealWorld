...
import { UtilitiesModule } from '../types';

const mockUtilities = mockDeep<UtilitiesModule>();
...
export { mockUtilities };

export const getMockUtilities = (): MockProxy<UtilitiesModule> => mockUtilities;
